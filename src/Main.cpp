...
int main(){
    ...
    Graphe g2 = g1.kruskal();
    cout << "test kruskal : " << g2 <<"\n";
    GarbageCollector::test();

    cout << "\ntest g1copy : " << g1copy <<"\n";
    g1copy.ajoute_arete(s3, s5, 1);
    cout << "test ajoute_arete à partir de deux sommets existants et d'un poids: " << g1copy <<"\n";
    g1copy.ajoute_arete("s1", "s5", 3);
    cout << "test g1copy : " << g1copy <<"\n";
